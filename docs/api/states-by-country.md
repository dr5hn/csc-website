...
var request = http.Request('GET', Uri.parse('https://api.countrystatecity.in/v1/countries/IN/states'));
...
```
  ...
  uri = URI('https://api.countrystatecity.in/v1/countries/IN/states')
  ...
  country_states = JSON.parse(response.body)
  p country_states
  ```
  </TabItem>
  ...
  class Program
  {
      static async Task Main(string[] args)
      {
          ...
          var request = new HttpRequestMessage
          {
              ...
              RequestUri = new Uri("https://api.countrystatecity.in/v1/countries/IN/states"),
              Headers =
              {
                  { "X-CSCAPI-KEY", "API_KEY" },
              },
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          ...
          HttpRequest request = HttpRequest.newBuilder()
              .uri(URI.create("https://api.countrystatecity.in/v1/countries/IN/states"))
  ...
  let request = NSMutableURLRequest(url: NSURL(string: "https://api.countrystatecity.in/v1/countries/IN/states")! as URL,
